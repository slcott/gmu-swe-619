...
>> I identified that there is a difference in that Python contains two fields to store a reference to the Exception that caused the current Exception (if such a cause exists). These fields are __context__ and __cause__. 
